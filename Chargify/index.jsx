...
const ChargifyForm = ({ paymentType = "Credit Card" }) => {
  ...
  useEffect(
    () => {
      ...
      console.log("In chargify use effect ", chargify);
      return undefined;
  ...
  return (
    <form onSubmit={handleSubmit} ref={chargifyForm}>
      ...
      <label>
        Hidden Token: <input id="host-token" onChange={(e) => console.log("onChange",e.target.value)}  value={token}/>
      </label>
      <p>
